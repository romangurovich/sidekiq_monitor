...
(function() {
  ...
  SidekiqMonitor.QueueJobsTable = (function(superClass) {
    extend(QueueJobsTable, superClass);

    function QueueJobsTable() {
      this.load_selected_queue = bind(this.load_selected_queue, this);
      this.show_queue_stats = bind(this.show_queue_stats, this);
