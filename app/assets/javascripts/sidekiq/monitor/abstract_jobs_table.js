...
(function() {
  ...
  SidekiqMonitor.AbstractJobsTable = (function() {
    function AbstractJobsTable() {
      this.format_time_ago = bind(this.format_time_ago, this);
      this.start_polling = bind(this.start_polling, this);
      this.reload_table = bind(this.reload_table, this);
      this.on_poll = bind(this.on_poll, this);
      this.show_job = bind(this.show_job, this);
      this.initialize_ui = bind(this.initialize_ui, this);
      this.initialize_with_options = bind(this.initialize_with_options, this);
      this.api_params = {};
      this.initialize();
    }
